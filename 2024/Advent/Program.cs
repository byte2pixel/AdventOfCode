...
app.Configure(config =>
{
    ...
    config.AddCommand<Day24Command>("day24").WithDescription("Advent of Code 2024 Day 24");
    config.AddCommand<Day25Command>("day25").WithDescription("Advent of Code 2024 Day 25");
});
